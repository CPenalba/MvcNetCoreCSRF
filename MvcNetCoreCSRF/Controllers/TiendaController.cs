...
namespace MvcNetCoreCSRF.Controllers
{
    public class TiendaController : Controller
    {
        ...
        {
            //SI EL USUARIO NO SE HA VALIDADO TODAVIA LO LLEVAMOS A DENIED
        ...
        public IActionResult Productos(string direccion, string[] producto)
        {
            ...
            {
                //MEDIANTE TEMPDATA SE ALMACENA LA INFORMACION PARA SER ENVIADA A OTROS CONTROLLERS
                //O METODOS IAACTIONRESULT EN LAS REDIRECCIONES
        ...
        {
            //AQUI NECESITO LOS PRODUCTOS Y LA DIRECCION DEL METODO POST DE PRODUCTOS.
            //COMO LOS RECUPERO AQUI??
